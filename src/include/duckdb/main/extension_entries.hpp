...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"make_timestamp_from_tai", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    {"make_timestamp_from_tai_ms", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    ...
    {"tai_epoch", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    {"tai_epoch_ms", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
