...
static const StaticFunctionDefinition core_functions[] = {
	...
	DUCKDB_SCALAR_FUNCTION(MakeTimestampFromTaiFun),
	DUCKDB_SCALAR_FUNCTION(MakeTimestampFromTaiMsFun),
	...
	DUCKDB_SCALAR_FUNCTION(TaiEpochFun),
	DUCKDB_SCALAR_FUNCTION(TaiEpochMsFun),
